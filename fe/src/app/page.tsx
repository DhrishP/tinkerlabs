    ...
    <div className="min-h-screen p-6 sm:p-10 playful-bg">
      <div className="mb-8 relative">
        <div className="flex items-center justify-center">
          <h1 className="text-4xl sm:text-7xl font-black text-center">TInkerLab</h1>
          <a
            href="https://github.com/whycurious"
            target="_blank"
            rel="noopener noreferrer"
            className="absolute right-0 top-1/2 -translate-y-1/2 inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/85 backdrop-blur border border-black/10 hover:bg-white"
            aria-label="GitHub"
            title="GitHub"
          >
        ...
        <p className="mt-2 text-center text-base sm:text-xl">A store of useful softwares made by a tinkerer</p>
      </div>
